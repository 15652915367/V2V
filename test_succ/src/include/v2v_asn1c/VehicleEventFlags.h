...
typedef enum VehicleEventFlags {
	VehicleEventFlags_eventHazrdLights	= 0,
	...
	VehicleEventFlags_eventReservedl	= 6,
	VehicleEventFlags_eventHardBraking	= 7,
	VehicleEventFlags_eventLinghtsChanged	= 8,
	VehicleEventFlags_enentWipersChanged	= 9,
	VehicleEventFlags_eventFlatTire	= 10,
	VehicleEventFlags_eventDisabledVehicle	= 11,
	VehicleEventFlags_eventAirBagDeloyment	= 12
} e_VehicleEventFlags;
