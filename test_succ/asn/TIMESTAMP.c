...
asn_dec_rval_t
TIMESTAMP_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
TIMESTAMP_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_TIMESTAMP = {
	...
	TIMESTAMP_decode_uper,
	TIMESTAMP_encode_uper,
